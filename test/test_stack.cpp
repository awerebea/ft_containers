...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/02/13 16:44:18 by awerebea          #+#    #+#             */
/*                                                    ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
protected:
	void SetUp() {
		int_sort_std = new std::stack<int>;
		for (int i = 0; i < 5; ++i) {
			int_sort_std->push(i + 1);
		}
		int_sort_ft = new ft::Stack<int>;
		for (int i = 0; i < 5; ++i) {
			int_sort_ft->push(i + 1);
		}
		int unsort_int_arr[] = { 8, 0, 6, 9, 7, 33, 44, 11, 22 };
		int_unsort_std = new std::stack<int>;
		for (int i = 0; i < 9; ++i) {
			int_unsort_std->push(unsort_int_arr[i]);
		}
		int_unsort_ft = new ft::Stack<int>;
		for (int i = 0; i < 9; ++i) {
	...
	std::stack<int> * int_sort_std;
	ft::Stack<int> * int_sort_ft;

	std::stack<int> * int_unsort_std;
	ft::Stack<int> * int_unsort_ft;
};

TEST_F(Test_Stack, Constructor) {
	std::cout << "----- CONSTRUCTOR (default) -----" << std::endl;
	std::stack<int> ctnr_std;
	ft::Stack<int> ctnr_ft;
...
TEST_F(Test_Stack, Top) {
	...
	compare_elements(int_sort_std->top(), int_sort_ft->top());
	EXPECT_EQ(int_sort_std->top(), int_sort_ft->top());
}

TEST_F(Test_Stack, Push) {
	std::cout << "----- PUSH -----" << std::endl;
	compare_size(*int_sort_std, *int_sort_ft, " before");
	compare_elements(int_sort_std->top(), int_sort_ft->top(), " top() before");
	EXPECT_EQ(int_sort_std->size(), int_sort_ft->size());
	EXPECT_EQ(int_sort_std->top(), int_sort_ft->top());
	...
	compare_elements(int_sort_std->top(), int_sort_ft->top(), " top() after");
	EXPECT_EQ(int_sort_std->size(), int_sort_ft->size());
	EXPECT_EQ(int_sort_std->top(), int_sort_ft->top());
}
...
TEST_F(Test_Stack, Relational_operators_Equal) {
...
TEST_F(Test_Stack, Relational_operators_Not_equal) {
	std::cout << "----- RELATIONAL OPERATORS != -----" << std::endl;
	std::cout << "Comparsion (1,2,3,4,5) and (8,0,6,9,7,33,44,11,22) containers"
		<< std::endl;
...
TEST_F(Test_Stack, Relational_operators_Less) {
	std::cout << "----- RELATIONAL OPERATORS < -----" << std::endl;
	std::cout << "Comparsion (1,2,3,4,5) and (8,0,6,9,7,33,44,11,22) containers"
		<< std::endl;
...
TEST_F(Test_Stack, Relational_operators_Less_or_equal) {
	std::cout << "----- RELATIONAL OPERATORS <= -----" << std::endl;
	std::cout << "Comparsion (1,2,3,4,5) and (8,0,6,9,7,33,44,11,22) containers"
		<< std::endl;
...
TEST_F(Test_Stack, Relational_operators_More) {
	std::cout << "----- RELATIONAL OPERATORS > -----" << std::endl;
	std::cout << "Comparsion (1,2,3,4,5) and (8,0,6,9,7,33,44,11,22) containers"
		<< std::endl;
...
TEST_F(Test_Stack, relational_operators_More_or_equal) {
	std::cout << "----- RELATIONAL OPERATORS >= -----" << std::endl;
	std::cout << "Comparsion (1,2,3,4,5) and (8,0,6,9,7,33,44,11,22) containers"
		<< std::endl;
